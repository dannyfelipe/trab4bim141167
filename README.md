...
# Parte 14 - Exportando arquivo XML com fileDownload e Jdom. Implementado o método para gerar e exportar os registros do banco de dados em um arquivo XML, utilizando o componente fileDownload do PrimeFaces. Criado os arquivos: ExportarRegistrosXmlController, responsável por gerar e exportar o arquivo de backup em XML; a View exportarRegistrosXML.xhtml, responsável pela exibição da página de download do arquivo de backup dos registros no banco de dados. Alterado o arquivo: header.xhtml, adicionada a chamada para a view de exportar arquivo em XML.